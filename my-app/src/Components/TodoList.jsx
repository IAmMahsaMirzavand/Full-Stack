          ...
          <Row className="h-100">
            ...
            <Col xs={12} md={10} className="my-4" style={{ height: '100%', overflowY: 'auto' }}>
              <div style={{ paddingLeft: '25px' }}>
                ...
                <Routes>
  <Route path="/" element={<MainContent tasks={tasks} setTaskCount={setTaskCount} onToggleImportant={toggleImportant} onToggleStatus={toggleStatus} />} />
  <Route path="/important" element={<MainContent tasks={tasks} setTaskCount={setTaskCount} onToggleImportant={toggleImportant} onToggleStatus={toggleStatus} filter="important" />} />
  <Route path="/completed" element={<MainContent tasks={tasks} setTaskCount={setTaskCount} onToggleImportant={toggleImportant} onToggleStatus={toggleStatus} filter="completed" />} />
  <Route path="/uncompleted" element={<MainContent tasks={tasks} setTaskCount={setTaskCount} onToggleImportant={toggleImportant} onToggleStatus={toggleStatus} filter="uncompleted" />} />
